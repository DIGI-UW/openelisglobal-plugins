# CobasTaqMan48VL Plugin

Roche Cobas TaqMan 48 viral load testing plugin.

## Identification

- **File Pattern**: File contains `Test` column AND next line contains `HI2CAP48` or `IFS48CDC`
...
```bash
cd plugins/analyzers/CobasTaqMan48VL
mvn clean package
```
