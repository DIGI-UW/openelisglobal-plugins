...
public class MindrayMenu extends MenuPlugin {
  ...
  protected void insertMenu() {
    ...
    service.insertLanguageKeyValue(
        "banner.menu.results.mindrayanalyzer", "Mindray", Locale.ENGLISH.toLanguageTag());
    // Analyzer name in French
    service.insertLanguageKeyValue(
        "banner.menu.results.mindrayanalyzer", "Mindray", Locale.FRENCH.toLanguageTag());
  }
}
