...
public class HttpHl7TemplateAnalyzerImplementation extends AnalyzerLineInserter {
	...
	public HttpHl7TemplateAnalyzerAnalyzerImplementation() {
	...
	public String getError() {
		return "HttpHl7TemplateAnalyzer analyzer unable to write to database";
	}
