...
Sysmex XT-2000i hematology analyzer file-based plugin.

## Identification

- **File Pattern**: File contains `ID Instrument` column AND data contains `XT-2000i`
...
Supports 17 CBC parameters with 5-part differential:
...
| NEUT#, LYMPH#, MONO#, EO#, BASO# | Differential Counts | 10/µL |
...
```bash
cd plugins/analyzers/Sysmex2000i
mvn clean package
```
